...
public class UserDao {
	...
	//---------find employee id in database based from employee's email input-------------
	public int searchEmployeeIdInDatabase(String userEmail){
		...
		Connection connection = null;
		 ...
		 try{
				 ...
				 final PreparedStatement searchUserStatement =
						 connection.prepareStatement("select employeeId, email from " +
	...
	public List<User> retrieveUserDetails(String userEmail) {
		Connection connection = null;
			...
			try {
				...
				final PreparedStatement retrieveDetailsStatement = 
				...
				while(rs.next()) {
					...
					final String regularizationDate = rs.getString("regularizationDate");
	...
	public List<Employee> findSupervisor(int supervisorId){
		...
		Employee employee = new Employee();
			try{
				...
				final PreparedStatement retrieveSupervisor = 
